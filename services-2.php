...
<body class="page-body">
            ...
            <div id="main-menu">
                ...
                <div class="list-group">
                    ...
                    <div class="collapse sub-menu" id="pages-links" data-bs-parent="#main-menu">
                        ...
                        <a href="#" class="list-group-item active">Services 2</a>
    ...
    <div class="canvas">
        ...
        <div class="page-cover">
            <div class="container-fluid">
                <h3><span class="cover-left-icon float-start"><i class="fa fa-cogs"></i></span>Services 2<span
                ...
                <div class="container-fluid text-center">
                    ...
                    <div id="services" class="no-back">
                        <div class="service-block service-block-2">
                            ...
                            <div class="service-block-2-text">
                                <h4>Quality Serve</h4>
                                <p>Lorem ipsum dolor sit amet, consectetur icing elit. Voluptatibus a mollitia, numquam
                                    similique.</p>
                            </div><!-- end service-block-2-text -->
