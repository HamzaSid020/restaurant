...
<body class="page-body">
            ...
            <div id="main-menu">
                ...
                <div class="list-group">
                    ...
                    <div class="collapse sub-menu" id="pages-links" data-bs-parent="#main-menu">
                        ...
                        <a href="#" class="list-group-item active">Pricing 2</a>
    ...
    <div class="canvas">
        ...
        <div class="page-cover">
            <div class="container-fluid">
                <h3><span class="cover-left-icon float-start"><i class="fa fa-dollar-sign"></i></span>Pricing 2<span
        ...
        <section class="page-wrapper innerpage-section-padding">
            <div id="pricing-page-2">
                <div class="container-fluid text-center">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="p-table-block p-table-block-2">
