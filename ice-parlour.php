...
<body id="iceparlour-homepage" class="page-body">
            ...
            <div id="main-menu">
                ...
                <div class="list-group">
                    ...
                    <div class="collapse sub-menu" id="homepage-links" data-bs-parent="#main-menu">
                        ...
                        <a href="#" class="list-group-item active">Ice Parlour</a>
                    </div><!-- end sub-menu -->
    ...
    <div id="shopping-cart-sidebar" class="shc-sidebar">
        <ul class="list-unstyled cart-list">
            <li>
                <div class="cart-item">
                    <div class="item-text dish-list-text">
                        <h4><a href="#">Dessert-3</a></h4>
                        <p>Lorem ipsum,dolor</p>
                        <h5>Qty: <input type="number" class="form-control" min="1" value="1"> x $45</h5>
                    </div><!-- end item-text -->

                    <div class="item-img">
                        <a href="#"><img src="images/ice-dessert-3.png" class="img-fluid" alt="cart-item-img" /></a>
                    </div><!-- end item-img -->
            ...
            <li>
                <div class="cart-item">
                    <div class="item-text dish-list-text">
                        <h4><a href="#">Shake-4</a></h4>
                        <p>Lorem ipsum,dolor</p>
                        <h5>Qty: <input type="number" class="form-control" min="1" value="1"> x $45</h5>
                    </div><!-- end item-text -->

                    <div class="item-img">
                        <a href="#"><img src="images/ice-shake-4.png" class="img-fluid" alt="cart-item-img" /></a>
                    </div><!-- end item-img -->
    ...
    <div id="user-profile-sidebar" class="user-prf-sidebar">
        <div class="user-prf-sidebar-img text-center" style="background:url('images/usr-prf-back-iceparlour.jpg');
    ...
    <div class="canvas">
        ...
        <div class="header height-auto">
            <div class="top-bar black">
                <div class="container-fluid">
                    <ul class="list-unstyled list-inline social-cart">
                        <li class="list-inline-item"><a href="#"><span><i class="fab fa-facebook-f"></i></span></a></li>
                        ...
                        <li class="list-inline-item"><a href="#"><span><i class="fab fa-dribbble"></i></span></a></li>
                        <li class="list-inline-item"><a href="javascript:void(0)" id="shc-side-open">My Cart (2)<span><i
        ...
        <div class="flexslider flex-control-nav-black" id="slider">
            <ul class="slides">
                ...
                <li class="item-1"
                    style="background:url('images/iceparlour-slider-1.jpg') center center; background-size:cover;">
                    <div class="overlay">
                        <div class="container text-center meta">
                            <h1 class="mg-b-4">Its Time to Taste</h1>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit consectetur adipisicing elit.
                            </p>
                            <span class="meta-highlight mg-t-10 meta-black">Starting From 50$</span>
                        </div>
                    </div>
                </li><!-- end item-1 -->

                <li class="item-2"
                    style="background:url('images/iceparlour-slider-2.jpg') center center; background-size:cover;">
                    <div class="overlay">
                        <div class="container text-center meta">
                            <h1 class="mg-b-4">Its Time to Taste</h1>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit consectetur adipisicing elit.
        ...
        <!--============= MENU ============-->
        <section class="menu box-menu-2 section-padding">
            <div class="container-fluid text-center">
                <h3 class="page-heading">Our Products</h3>
                <hr class="page-heading-line" />
                <ul class="nav nav-tabs justify-content-center">
                    <li class="nav-item"><a class="nav-link active" href="#ice-desserts" data-bs-toggle="tab">Desserts</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="#ice-cones" data-bs-toggle="tab">Cones</a></li>
                    <li class="nav-item"><a class="nav-link" href="#ice-shake" data-bs-toggle="tab">Shake</a></li>
                </ul>

                <div class="tab-content">

                    <div id="ice-desserts" class="tab-pane active">
                        <div class="owl-carousel owl-theme owl-auto-arrow owl-menu">
                            <div>
                                <div class="grid">
                                    <a href="menu-detail.html" class="dish-list-link">
                                        <div class="dish-list">
                                            <img src="images/ice-dessert-1.png" class="img-fluid" alt="ice-menu" />
                                ...
                                <div class="grid">
                                    <a href="menu-detail.html" class="dish-list-link">
                                        <div class="dish-list">
                                            <img src="images/ice-dessert-2.png" class="img-fluid" alt="ice-menu" />
                                            <div class="dish-list-text">
                                                <h4>Dessert 2</h4>
                                                <h5>$45</h5>
                                            </div><!-- end dish-list-text -->
                            ...
                            <div>
                                <div class="grid">
                                    <a href="menu-detail.html" class="dish-list-link">
                                        <div class="dish-list">
                                            <img src="images/ice-dessert-3.png" class="img-fluid" alt="ice-menu" />
                                            <div class="dish-list-text">
                                                <h4>Dessert 3</h4>
                                                <h5>$45</h5>
                                            </div><!-- end dish-list-text -->
                                ...
                                <div class="grid">
                                    <a href="menu-detail.html" class="dish-list-link">
                                        <div class="dish-list">
                                            <img src="images/ice-dessert-4.png" class="img-fluid" alt="ice-menu" />
                                            <div class="dish-list-text">
                                                <h4>Dessert 4</h4>
                                                <h5>$45</h5>
                                            </div><!-- end dish-list-text -->
                            ...
                            <div>
                                <div class="grid">
                                    <a href="menu-detail.html" class="dish-list-link">
                                        <div class="dish-list">
                                            <img src="images/ice-dessert-5.png" class="img-fluid" alt="ice-menu" />
                                            <div class="dish-list-text">
                                                <h4>Dessert 5</h4>
                                                <h5>$45</h5>
                                            </div><!-- end dish-list-text -->
                                ...
                                <div class="grid">
                                    <a href="menu-detail.html" class="dish-list-link">
                                        <div class="dish-list">
                                            <img src="images/ice-dessert-6.png" class="img-fluid" alt="ice-menu" />
                                            <div class="dish-list-text">
                                                <h4>Dessert 6</h4>
                                                <h5>$45</h5>
                                            </div><!-- end dish-list-text -->
                    ...
                    </div><!-- end ice-desserts -->

                    <div id="ice-cones" class="tab-pane fade">
                        <div class="owl-carousel owl-theme owl-auto-arrow owl-menu">
                            <div>
                                <div class="grid">
                                    <a href="menu-detail.html" class="dish-list-link">
                                        <div class="dish-list">
                                            <img src="images/ice-cone-1.png" class="img-fluid" alt="ice-menu" />
                                            <div class="dish-list-text">
                                                <h4>Cone 1</h4>
                                                <h5>$45</h5>
                                            </div><!-- end dish-list-text -->
                                ...
                                <div class="grid">
                                    <a href="menu-detail.html" class="dish-list-link">
                                        <div class="dish-list">
                                            <img src="images/ice-cone-2.png" class="img-fluid" alt="ice-menu" />
                                            <div class="dish-list-text">
                                                <h4>Cone 2</h4>
                                                <h5>$45</h5>
                                            </div><!-- end dish-list-text -->
                            ...
                            <div>
                                <div class="grid">
                                    <a href="menu-detail.html" class="dish-list-link">
                                        <div class="dish-list">
                                            <img src="images/ice-cone-3.png" class="img-fluid" alt="ice-menu" />
                                            <div class="dish-list-text">
                                                <h4>Cone 3</h4>
                                                <h5>$45</h5>
                                            </div><!-- end dish-list-text -->
                                ...
                                <div class="grid">
                                    <a href="menu-detail.html" class="dish-list-link">
                                        <div class="dish-list">
                                            <img src="images/ice-cone-4.png" class="img-fluid" alt="ice-menu" />
                                            <div class="dish-list-text">
                                                <h4>Cone 4</h4>
                                                <h5>$45</h5>
                                            </div><!-- end dish-list-text -->
                            ...
                            <div>
                                <div class="grid">
                                    <a href="menu-detail.html" class="dish-list-link">
                                        <div class="dish-list">
                                            <img src="images/ice-cone-5.png" class="img-fluid" alt="ice-menu" />
                                            <div class="dish-list-text">
                                                <h4>Cone 5</h4>
                                                <h5>$45</h5>
                                            </div><!-- end dish-list-text -->
                                ...
                                <div class="grid">
                                    <a href="menu-detail.html" class="dish-list-link">
                                        <div class="dish-list">
                                            <img src="images/ice-cone-6.png" class="img-fluid" alt="ice-menu" />
                                            <div class="dish-list-text">
                                                <h4>Cone 6</h4>
                                                <h5>$45</h5>
                                            </div><!-- end dish-list-text -->
                    ...
                    <div id="ice-shake" class="tab-pane fade">
                        <div class="owl-carousel owl-theme owl-auto-arrow owl-menu">
                            <div>
                                <div class="grid">
                                    <a href="menu-detail.html" class="dish-list-link">
                                        <div class="dish-list">
                                            <img src="images/ice-shake-1.png" class="img-fluid" alt="ice-menu" />
                                            <div class="dish-list-text">
                                                <h4>Shake 1</h4>
                                                <h5>$45</h5>
                                            </div><!-- end dish-list-text -->
                                ...
                                <div class="grid">
                                    <a href="menu-detail.html" class="dish-list-link">
                                        <div class="dish-list">
                                            <img src="images/ice-shake-2.png" class="img-fluid" alt="ice-menu" />
                                            <div class="dish-list-text">
                                                <h4>Shake 2</h4>
                                                <h5>$45</h5>
                                            </div><!-- end dish-list-text -->
                            ...
                            <div>
                                <div class="grid">
                                    <a href="menu-detail.html" class="dish-list-link">
                                        <div class="dish-list">
                                            <img src="images/ice-shake-3.png" class="img-fluid" alt="ice-menu" />
                                            <div class="dish-list-text">
                                                <h4>Shake 3</h4>
                                                <h5>$45</h5>
                                            </div><!-- end dish-list-text -->
                                ...
                                <div class="grid">
                                    <a href="menu-detail.html" class="dish-list-link">
                                        <div class="dish-list">
                                            <img src="images/ice-shake-4.png" class="img-fluid" alt="ice-menu" />
                                            <div class="dish-list-text">
                                                <h4>Shake 4</h4>
                                                <h5>$45</h5>
                                            </div><!-- end dish-list-text -->
                            ...
                            <div>
                                <div class="grid">
                                    <a href="menu-detail.html" class="dish-list-link">
                                        <div class="dish-list">
                                            <img src="images/ice-shake-5.png" class="img-fluid" alt="ice-menu" />
                                            <div class="dish-list-text">
                                                <h4>Shake 5</h4>
                                                <h5>$45</h5>
                                            </div><!-- end dish-list-text -->
                                ...
                                <div class="grid">
                                    <a href="menu-detail.html" class="dish-list-link">
                                        <div class="dish-list">
                                            <img src="images/ice-shake-6.png" class="img-fluid" alt="ice-menu" />
                                            <div class="dish-list-text">
                                                <h4>Shake 6</h4>
                                                <h5>$45</h5>
                                            </div><!-- end dish-list-text -->
        ...
        <!--==================== BANNER-2 ====================-->
        <section id="banner-2"
            style="background:url('images/banner-2-ice-parlour.jpg') center center; background-size:cover;">
            <div class="container-fluid section-padding black-overlay-7">
        ...
        <!--=============== OUR-PRICING ===============-->
        <section id="our-pricing" class="section-padding">
            <div class="container-fluid text-center">
                <h3 class="page-heading">Our Pricing</h3>
                <hr class="page-heading-line" />
