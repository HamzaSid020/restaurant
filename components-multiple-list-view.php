...
<head>
    <title>Multiple List View</title>
    <meta charset="utf-8">
...
<body class="page-body">
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <div id="main-menu">
                ...
                <div class="list-group">
                    <a href="#homepage-links" class="list-group-item" data-bs-toggle="collapse"><span><i
                    ...
                    <a href="#components-links" class="list-group-item active" data-bs-toggle="collapse"><span><i
                    ...
                    <div class="collapse sub-menu" id="components-links" data-bs-parent="#main-menu">
                        ...
                        <a href="components-modals.html" class="list-group-item">Modal</a>
                        ...
                        <a href="components-multiple-list-view.html" class="list-group-item active">Multiple List View</a>
    ...
    <div class="sidenav-content">
        <div class="sidenav-2 sidenav-pane">
            ...
            <div class="white-menu">
                ...
                <div class="list-group">
                    <a href="#homepage-links-2" class="list-group-item" data-bs-toggle="collapse"><span><i
                                class="fa fa-home sidebar-icon"></i></span>Homepages<span><i
                                class="fa fa-caret-down arrow"></i></span></a>
                    ...
                    <a href="#components-links-2" class="list-group-item active" data-bs-toggle="collapse"><span><i
                                class="fa fa-clone sidebar-icon"></i></span>Components<span><i
                                class="fa fa-caret-down arrow"></i></span></a>
                    <div class="collapse sub-menu" id="components-links-2" data-bs-parent="#main-menu">
                        <a href="components-notifications.html" class="list-group-item">Notifications</a>
                        <a href="components-toasts.html" class="list-group-item">Toast</a>
                        <a href="components-dialog-box.html" class="list-group-item">Dialog Box</a>
                        <a href="components-alert-boxes.html" class="list-group-item">Alert Box</a>
    ...
    <div id="fullscr-nav" class="fullscr-navigation">
        <button id="fullscr-close"><span>close</span></button>
        ...
        <ul class="list-unstyled cart-list">
            ...
            <li>
                <div class="cart-item">
                    ...
                    <div class="item-img">
                        <a href="#"><img src="images/dish-dinner-4.png" class="img-fluid" alt="cart-item-img" /></a>
                    </div><!-- end item-img -->
    ...
    <div class="canvas">
        ...
        <div class="page-cover">
            <div class="container-fluid">
                <h3><span class="cover-left-icon float-start"><i class="fa fa-info"></i></span>Alert Boxes<span
        ...
        <section class="page-wrapper innerpage-section-padding">
            <div class="list-view-page multi-list-view-page">
                <div class="heading-1">
                    <h4 class="heading-child">Simple List View</h4>
                </div>

                <div class="list-view simple">
                    <ul>
                        <li>
                            <a class="multi-btn" data-bs-toggle="collapse" href="#collapseExample-1" role="button"
                                aria-expanded="false" aria-controls="collapseExample-1">
                                Multi Link 1 <i class="fa fa-chevron-down"></i>
                            </a>
                            <div class="collapse" id="collapseExample-1">
                                <div class="card card-body">
                                    <ul>
                                        <li>List Item 1 <i class="fa fa-chevron-right"></i></li>
                                        <li>List Item 2 <i class="fa fa-chevron-right"></i></li>
                                        <li>List Item 3 <i class="fa fa-chevron-right"></i></li>
                                        <li>List Item 4 <i class="fa fa-chevron-right"></i></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
                        <li>
                            <a class="multi-btn" data-bs-toggle="collapse" href="#collapseExample-2" role="button"
                                aria-expanded="false" aria-controls="collapseExample-2">
                                Multi Link 2 <i class="fa fa-chevron-down"></i>
                            </a>
                        ...
                        <li>
                            <a class="multi-btn" data-bs-toggle="collapse" href="#collapseExample-3" role="button"
                                aria-expanded="false" aria-controls="collapseExample-3">
                                Multi Link 3 <i class="fa fa-chevron-down"></i>
                            </a>
                        ...
                        <li>
                            <a class="multi-btn" data-bs-toggle="collapse" href="#collapseExample-4" role="button"
                                aria-expanded="false" aria-controls="collapseExample-4">
                                Multi Link 4 <i class="fa fa-chevron-down"></i>
                            </a>
                ...
                <div class="heading-1">
                    <h4 class="heading-child">Link List View</h4>
                </div>

                <div class="list-view">
                    <ul>
                        <li>
                            <a class="multi-btn" data-bs-toggle="collapse" href="#collapseExample-5" role="button"
                                aria-expanded="false" aria-controls="collapseExample-5">
                                Multi Link 1 <i class="fa fa-chevron-down"></i>
                            </a>
                            <div class="collapse" id="collapseExample-5">
                                <div class="card card-body">
                                    <ul>
                                        <li><a href="#">List Item 1 <i class="fa fa-chevron-right"></i></a></li>
                                        <li><a href="#">List Item 2 <i class="fa fa-chevron-right"></i></a></li>
                                        <li><a href="#">List Item 3 <i class="fa fa-chevron-right"></i></a></li>
                                        <li><a href="#">List Item 4 <i class="fa fa-chevron-right"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
                        <li>
                            <a class="multi-btn" data-bs-toggle="collapse" href="#collapseExample-6" role="button"
                                aria-expanded="false" aria-controls="collapseExample-6">
                                Multi Link 2 <i class="fa fa-chevron-down"></i>
                            </a>
                        ...
                        <li>
                            <a class="multi-btn" data-bs-toggle="collapse" href="#collapseExample-7" role="button"
                                aria-expanded="false" aria-controls="collapseExample-7">
                                Multi Link 3 <i class="fa fa-chevron-down"></i>
                            </a>
                        ...
                        <li>
                            <a class="multi-btn" data-bs-toggle="collapse" href="#collapseExample-8" role="button"
                                aria-expanded="false" aria-controls="collapseExample-8">
                                Multi Link 4 <i class="fa fa-chevron-down"></i>
                            </a>
                ...
                <div class="heading-1">
                    <h4 class="heading-child">Badges List View</h4>
                </div>

                <div class="list-view">
                    <ul>
                        <li>
                            <a class="multi-btn" data-bs-toggle="collapse" href="#collapseExample-9" role="button"
                                aria-expanded="false" aria-controls="collapseExample-9">
                                Multi Link 1 <i class="fa fa-chevron-down"></i>
                            </a>
                            <div class="collapse" id="collapseExample-9">
                                <div class="card card-body">
                                    <ul>
                                        <li><a href="#">List Item 1 <i class="fa fa-chevron-right"></i> <span
                                                    class="badge bg-danger">20</span></a></li>
                                        <li><a href="#">List Item 2 <i class="fa fa-chevron-right"></i> <span
                                                    class="badge bg-success">20</span></a></li>
                                        <li><a href="#">List Item 3 <i class="fa fa-chevron-right"></i> <span
                                                    class="badge bg-primary">20</span></a></li>
                                        <li><a href="#">List Item 4 <i class="fa fa-chevron-right"></i> <span
                                                    class="badge bg-dark">20</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
                        <li>
                            <a class="multi-btn" data-bs-toggle="collapse" href="#collapseExample-10" role="button"
                                aria-expanded="false" aria-controls="collapseExample-10">
                                Multi Link 2 <i class="fa fa-chevron-down"></i>
                            </a>
                        ...
                        <li>
                            <a class="multi-btn" data-bs-toggle="collapse" href="#collapseExample-11" role="button"
                                aria-expanded="false" aria-controls="collapseExample-11">
                                Multi Link 3 <i class="fa fa-chevron-down"></i>
                            </a>
                        ...
                        <li>
                            <a class="multi-btn" data-bs-toggle="collapse" href="#collapseExample-12" role="button"
                                aria-expanded="false" aria-controls="collapseExample-12">
                                Multi Link 4 <i class="fa fa-chevron-down"></i>
                            </a>
                ...
                <div class="heading-1">
                    <h4 class="heading-child">Images List View</h4>
                </div>

                <div class="list-view image-view">
                    <ul>
                        <li>
                            <a class="multi-btn" data-bs-toggle="collapse" href="#collapseExample-17" role="button"
                                aria-expanded="false" aria-controls="collapseExample-17">
                                Image List 1 <i class="fa fa-chevron-down"></i>
                            </a>
                            <div class="collapse" id="collapseExample-17">
                                <div class="card card-body">
                                    <ul>
                                        <li><a href="#"><img src="images/user-profile.jpg" alt="list-image"
                                                    class="img-fluid"> Jeorge
                                                <i class="fa fa-chevron-right"></i> <span
                                                    class="badge">Designer</span></a></li>
                                        <li><a href="#"><img src="images/user-profile.jpg" alt="list-image"
                                                    class="img-fluid"> Gem Brit
                                                <i class="fa fa-chevron-right"></i> <span
                                                    class="badge">Developer</span></a></li>
                                        <li><a href="#"><img src="images/user-profile.jpg" alt="list-image"
                                                    class="img-fluid"> John
                                                <i class="fa fa-chevron-right"></i> <span
                                                    class="badge">Manager</span></a></li>
                                        <li><a href="#"><img src="images/user-profile.jpg" alt="list-image"
                                                    class="img-fluid"> Doe
                                                <i class="fa fa-chevron-right"></i> <span class="badge">Chef</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <li>
                            <a class="multi-btn" data-bs-toggle="collapse" href="#collapseExample-18" role="button"
                                aria-expanded="false" aria-controls="collapseExample-18">
                                Image List 2 <i class="fa fa-chevron-down"></i>
                            </a>
                        ...
                        <li>
                            <a class="multi-btn" data-bs-toggle="collapse" href="#collapseExample-19" role="button"
                                aria-expanded="false" aria-controls="collapseExample-19">
                                Image List 3 <i class="fa fa-chevron-down"></i>
                            </a>
                        ...
                        <li>
                            <a class="multi-btn" data-bs-toggle="collapse" href="#collapseExample-20" role="button"
                                aria-expanded="false" aria-controls="collapseExample-20">
                                Image List 4 <i class="fa fa-chevron-down"></i>
                            </a>
                ...
                <div class="heading-1">
                    <h4 class="heading-child">Icon List View</h4>
                </div>

                <div class="list-view icon-view">
                    <ul>
                        <li>
                            <a class="multi-btn" data-bs-toggle="collapse" href="#collapseExample-21" role="button"
                                aria-expanded="false" aria-controls="collapseExample-21">
                                Image List 1 <i class="fa fa-chevron-down"></i>
                            </a>
                            <div class="collapse" id="collapseExample-21">
                                <div class="card card-body">
                                    <ul>
                                        <li><a href="#"><i class="fa fa-images"></i> Jeorge
                                                <i class="fa fa-chevron-right"></i> </a></li>
                                        <li><a href="#"><i class="fa fa-images"></i> Gem Brit
                                                <i class="fa fa-chevron-right"></i> </a></li>
                                        <li><a href="#"><i class="fa fa-images"></i> John
                                                <i class="fa fa-chevron-right"></i> </a></li>
                                        <li><a href="#"><i class="fa fa-images"></i> Doe
                                                <i class="fa fa-chevron-right"></i> </a></li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <li>
                            <a class="multi-btn" data-bs-toggle="collapse" href="#collapseExample-22" role="button"
                                aria-expanded="false" aria-controls="collapseExample-22">
                                Image List 1 <i class="fa fa-chevron-down"></i>
                            </a>
                        ...
                        <li>
                            <a class="multi-btn" data-bs-toggle="collapse" href="#collapseExample-23" role="button"
                                aria-expanded="false" aria-controls="collapseExample-23">
                                Image List 1 <i class="fa fa-chevron-down"></i>
                            </a>
                        ...
                        <li>
                            <a class="multi-btn" data-bs-toggle="collapse" href="#collapseExample-24" role="button"
                                aria-expanded="false" aria-controls="collapseExample-24">
                                Image List 1 <i class="fa fa-chevron-down"></i>
                            </a>
                ...
                <div class="list-view image-list-view">
                    <ul>
                        <li>
                            <a class="multi-btn" data-bs-toggle="collapse" href="#collapseExample-25" role="button"
                                aria-expanded="false" aria-controls="collapseExample-25">
                                <img src="images/sweet-donut-6.png" alt="list-image" class="img-fluid"> Jeorge
                                <i class="fa fa-chevron-right"></i> <span class="badge">20 Photos</span></a>
                            </a>
                            <div class="collapse" id="collapseExample-25">
                                <div class="card card-body">
                                    <ul>
                                        <li><a href="#"><img src="images/sweet-donut-6.png" alt="list-image"
                                                    class="img-fluid"> Jeorge
                                                <i class="fa fa-chevron-right"></i> <span class="badge">20
                                                    Photos</span></a></li>
                                        <li><a href="#"><img src="images/sweet-donut-6.png" alt="list-image"
                                                    class="img-fluid"> Gem Brit
                                                <i class="fa fa-chevron-right"></i> <span class="badge">20
                        ...
                        <li>
                            <a class="multi-btn" data-bs-toggle="collapse" href="#collapseExample-26" role="button"
                                aria-expanded="false" aria-controls="collapseExample-26">
                                <img src="images/sweet-donut-6.png" alt="list-image" class="img-fluid"> Jeorge
                                <i class="fa fa-chevron-right"></i> <span class="badge">20 Photos</span></a>
                            </a>
                        ...
                        <li>
                            <a class="multi-btn" data-bs-toggle="collapse" href="#collapseExample-27" role="button"
                                aria-expanded="false" aria-controls="collapseExample-27">
                                <img src="images/sweet-donut-6.png" alt="list-image" class="img-fluid"> Jeorge
                                <i class="fa fa-chevron-right"></i> <span class="badge">20 Photos</span></a>
                            </a>
                            <div class="collapse" id="collapseExample-27">
                                <div class="card card-body">
                                    <ul>
                                        <li><a href="#"><img src="images/sweet-donut-6.png" alt="list-image"
                                                    class="img-fluid"> Jeorge
                        ...
                        <li>
                            <a class="multi-btn" data-bs-toggle="collapse" href="#collapseExample-28" role="button"
                                aria-expanded="false" aria-controls="collapseExample-28">
                                <img src="images/sweet-donut-6.png" alt="list-image" class="img-fluid"> Jeorge
                                <i class="fa fa-chevron-right"></i> <span class="badge">20 Photos</span></a>
                            </a>
                            <div class="collapse" id="collapseExample-28">
                                <div class="card card-body">
                                    <ul>
                                        <li><a href="#"><img src="images/sweet-donut-6.png" alt="list-image"
                                                    class="img-fluid"> Jeorge
