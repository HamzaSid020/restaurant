...
<body class="page-body">
            ...
            <div id="main-menu">
                ...
                <div class="list-group">
                    ...
                    <div class="collapse sub-menu" id="pages-links" data-bs-parent="#main-menu">
                        ...
                        <a href="#" class="list-group-item active">Testimonials 2</a>
    ...
    <div class="canvas">
        ...
        <div class="page-cover">
            <div class="container-fluid">
                <h3><span class="cover-left-icon float-start"><i class="fa fa-comments"></i></span>Testimonials 2<span
                        class="cover-right-icon float-end"><i class="fa fa-comments"></i></span></h3>
            </div><!-- end container-fluid -->
        </div><!-- end page-cover -->
            ...
            <div id="testimonial-page-2">
                <div class="container-fluid text-center">
                    ...
                    <div class="owl-carousel owl-theme" id="owl-testimonial">
                        ...
                        <div class="item">
                            <div class="review-block review-block-2">
