...
<body class="page-body">
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <div id="main-menu">
                ...
                <div class="list-group">
                    ...
                    <a href="#" class="list-group-item active"><span><i
    ...
    <div class="canvas">
        ...
        <div class="page-cover">
            <div class="container-fluid">
                <h3><span class="cover-left-icon float-start"><i class="fa fa-pencil-alt"></i></span>Reservation<span
                        class="cover-right-p float-end"><i class="fa fa-pencil-alt"></i></span></h3>
            </div><!-- end container-fluid -->
        </div><!-- end page-cover -->
            ...
            <div id="reservation-page">
                <div class="container-fluid text-center">
                    ...
                    <form class="custom-form">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <input type="text" class="form-control dpd" placeholder="Date" required />
                                <div class="input-group-append">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <input type="number" class="form-control" min="1" placeholder="Seats" required />
                                <div class="input-group-append">
                        ...
                        <button class="btn btn-orange btn-radius">Book Now</button>
                    </form>
                </div><!-- end container-fluid -->
