...
<body id="bakery-homepage" class="page-body">
            ...
            <div id="main-menu">
                ...
                <div class="list-group">
                    ...
                    <div class="collapse sub-menu" id="homepage-links" data-bs-parent="#main-menu">
                        ...
                        <a href="#" class="list-group-item active">Bakery</a>
    ...
    <div id="shopping-cart-sidebar" class="shc-sidebar">
        <ul class="list-unstyled cart-list">
            <li>
                <div class="cart-item">
                    <div class="item-text dish-list-text">
                        <h4><a href="#">Cupcake-3</a></h4>
                        <p>Lorem ipsum,dolor</p>
                        <h5>Qty: <input type="number" class="form-control" min="1" value="1"> x $45</h5>
                    </div><!-- end item-text -->

                    <div class="item-img">
                        <a href="#"><img src="images/sweet-cupcake-3.png" class="img-fluid" alt="cart-item-img" /></a>
                    </div><!-- end item-img -->
            ...
            <li>
                <div class="cart-item">
                    <div class="item-text dish-list-text">
                        <h4><a href="#">Cookie-4</a></h4>
                        <p>Lorem ipsum,dolor</p>
                        <h5>Qty: <input type="number" class="form-control" min="1" value="1"> x $45</h5>
                    </div><!-- end item-text -->

                    <div class="item-img">
                        <a href="#"><img src="images/sweet-cookie-4.png" class="img-fluid" alt="cart-item-img" /></a>
                    </div><!-- end item-img -->
    ...
    <div id="user-profile-sidebar" class="user-prf-sidebar">
        <div class="user-prf-sidebar-img text-center" style="background:url('images/usr-prf-back-bakery.jpg') center center;
            ...
            <div class="container-fluid text-center">
                ...
                <div class="menu">
                    <div class="owl-carousel owl-theme owl-auto-arrow" id="owl-best-sellers">
                        <div class="item">
                            <div class="dish-list">
                                ...
                                <div class="dish-list-text">
                                    <h4><a href="menu-detail.html">Cupcake</a></h4>
                                    <h5>$45</h5>
                                    <p>Lorem ipsum, Dolor</p>
                        ...
                        <div class="item">
                            <div class="dish-list">
                                <a href="menu-detail.html"><img src="images/sweet-donut-1.png" class="img-fluid"
                                        alt="dish-menu" /></a>
                                <div class="dish-list-text">
                                    <h4><a href="menu-detail.html">Donut</a></h4>
                                    <h5>$45</h5>
                                    <p>Lorem ipsum, Dolor</p>
                                    <button class="btn">Add to cart<span><i
                                                class="fa fa-shopping-cart"></i></span></button>
                        ...
                        <div class="item">
                            <div class="dish-list">
                                <a href="menu-detail.html"><img src="images/sweet-cupcake-2.png" class="img-fluid"
                                        alt="dish-menu" /></a>
                                <div class="dish-list-text">
                                    <h4><a href="menu-detail.html">Cupcake</a></h4>
                                    <h5>$45</h5>
                        ...
                        <div class="item">
                            <div class="dish-list">
                                <a href="menu-detail.html"><img src="images/sweet-cookie-1.png" class="img-fluid"
                                        alt="dish-menu" /></a>
                                <div class="dish-list-text">
                                    <h4><a href="menu-detail.html">Cookie</a></h4>
                                    <h5>$45</h5>
                                    <p>Lorem ipsum, Dolor</p>
                                    <button class="btn">Add to cart<span><i
                                                class="fa fa-shopping-cart"></i></span></button>
        ...
        <section class="menu section-padding">
            <div class="container-fluid text-center">
                ...
                <ul class="nav nav-tabs justify-content-center">
                    <li class="nav-item"><a class="nav-link active" href="#sweet-cupcakes"
                            data-bs-toggle="tab">Cupcakes</a></li>
                    <li class="nav-item"><a class="nav-link" href="#sweet-donuts" data-bs-toggle="tab">Donuts</a></li>
                    <li class="nav-item"><a class="nav-link" href="#sweet-cookies" data-bs-toggle="tab">Cookies</a></li>
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <div id="sweet-cupcakes" class="tab-pane active">
                        <div class="owl-carousel owl-theme owl-auto-arrow owl-menu">
                            <div>
                                <div class="grid">
                                    <div class="dish-list">
                                        ...
                                        <div class="dish-list-text">
                                            <h4><a href="menu-detail.html">Cupcake-1</a></h4>
                                            <h5>$45</h5>
                                            <p>Lorem ipsum, Dolor</p>
                                            <button class="btn">Add to cart<span><i
                                                        class="fa fa-shopping-cart"></i></span></button>
                                ...
                                <div class="grid">
                                    <div class="dish-list">
                                        <a href="menu-detail.html"><img src="images/sweet-cupcake-2.png"
                                                class="img-fluid" alt="dish-menu" /></a>
                                        <div class="dish-list-text">
                                            <h4><a href="menu-detail.html">Cupcake-2</a></h4>
                                            <h5>$45</h5>
                                            <p>Lorem ipsum, Dolor</p>
                                            <button class="btn">Add to cart<span><i
                                                        class="fa fa-shopping-cart"></i></span></button>
                            ...
                            <div>
                                <div class="grid">
                                    <div class="dish-list">
                                        <a href="menu-detail.html"><img src="images/sweet-cupcake-3.png"
                                                class="img-fluid" alt="dish-menu" /></a>
                                        <div class="dish-list-text">
                                            <h4><a href="menu-detail.html">Cupcake-3</a></h4>
                                            <h5>$45</h5>
                                            <p>Lorem ipsum, Dolor</p>
                                            <button class="btn">Add to cart<span><i
                                                        class="fa fa-shopping-cart"></i></span></button>
                                ...
                                <div class="grid">
                                    <div class="dish-list">
                                        <a href="menu-detail.html"><img src="images/sweet-cupcake-4.png"
                                                class="img-fluid" alt="dish-menu" /></a>
                                        <div class="dish-list-text">
                                            <h4><a href="menu-detail.html">Cupcake-4</a></h4>
                                            <h5>$45</h5>
                                            <p>Lorem ipsum, Dolor</p>
                                            <button class="btn">Add to cart<span><i
                                                        class="fa fa-shopping-cart"></i></span></button>
                            ...
                            <div>
                                <div class="grid">
                                    <div class="dish-list">
                                        <a href="menu-detail.html"><img src="images/sweet-cupcake-5.png"
                                                class="img-fluid" alt="dish-menu" /></a>
                                        <div class="dish-list-text">
                                            <h4><a href="menu-detail.html">Cupcake-5</a></h4>
                                            <h5>$45</h5>
                                            <p>Lorem ipsum, Dolor</p>
                                            <button class="btn">Add to cart<span><i
                                                        class="fa fa-shopping-cart"></i></span></button>
                                ...
                                <div class="grid">
                                    <div class="dish-list">
                                        <a href="menu-detail.html"><img src="images/sweet-cupcake-6.png"
                                                class="img-fluid" alt="dish-menu" /></a>
                                        <div class="dish-list-text">
                                            <h4><a href="menu-detail.html">Cupcake-6</a></h4>
                                            <h5>$45</h5>
                                            <p>Lorem ipsum, Dolor</p>
                                            <button class="btn">Add to cart<span><i
                                                        class="fa fa-shopping-cart"></i></span></button>
                    ...
                    <div id="sweet-donuts" class="tab-pane fade">
                        <div class="owl-carousel owl-theme owl-auto-arrow owl-menu">
                                ...
                                <div class="grid">
                                    <div class="dish-list">
                                        <a href="menu-detail.html"><img src="images/sweet-donut-1.png" class="img-fluid"
                                                alt="dish-menu" /></a>
                                        <div class="dish-list-text">
                                            <h4><a href="menu-detail.html">Donut-1</a></h4>
                                            <h5>$45</h5>
                                            <p>Lorem ipsum, Dolor</p>
                                            <button class="btn">Add to cart<span><i
                                                        class="fa fa-shopping-cart"></i></span></button>
                                ...
                                <div class="grid">
                                    <div class="dish-list">
                                        <a href="menu-detail.html"><img src="images/sweet-donut-2.png" class="img-fluid"
                                                alt="dish-menu" /></a>
                                        <div class="dish-list-text">
                                            <h4><a href="menu-detail.html">Donut-2</a></h4>
                                            <h5>$45</h5>
                                            <p>Lorem ipsum, Dolor</p>
                                            <button class="btn">Add to cart<span><i
                                                        class="fa fa-shopping-cart"></i></span></button>
                            ...
                            <div>
                                <div class="grid">
                                    <div class="dish-list">
                                        <a href="menu-detail.html"><img src="images/sweet-donut-3.png" class="img-fluid"
                                                alt="dish-menu" /></a>
                                        <div class="dish-list-text">
                                            <h4><a href="menu-detail.html">Donut-3</a></h4>
                                            <h5>$45</h5>
                                            <p>Lorem ipsum, Dolor</p>
                                            <button class="btn">Add to cart<span><i
                                                        class="fa fa-shopping-cart"></i></span></button>
                                ...
                                <div class="grid">
                                    <div class="dish-list">
                                        <a href="menu-detail.html"><img src="images/sweet-donut-4.png" class="img-fluid"
                                                alt="dish-menu" /></a>
                                        <div class="dish-list-text">
                                            <h4><a href="menu-detail.html">Donut-4</a></h4>
                                            <h5>$45</h5>
                                            <p>Lorem ipsum, Dolor</p>
                                            <button class="btn">Add to cart<span><i
                                                        class="fa fa-shopping-cart"></i></span></button>
                            ...
                            <div>
                                <div class="grid">
                                    <div class="dish-list">
                                        <a href="menu-detail.html"><img src="images/sweet-donut-5.png" class="img-fluid"
                                                alt="dish-menu" /></a>
                                        <div class="dish-list-text">
                                            <h4><a href="menu-detail.html">Donut-5</a></h4>
                                            <h5>$45</h5>
                                            <p>Lorem ipsum, Dolor</p>
                                            <button class="btn">Add to cart<span><i
                                                        class="fa fa-shopping-cart"></i></span></button>
                                ...
                                <div class="grid">
                                    <div class="dish-list">
                                        <a href="menu-detail.html"><img src="images/sweet-donut-6.png" class="img-fluid"
                                                alt="dish-menu" /></a>
                                        <div class="dish-list-text">
                                            <h4><a href="menu-detail.html">Donut-6</a></h4>
                                            <h5>$45</h5>
                                            <p>Lorem ipsum, Dolor</p>
                                            <button class="btn">Add to cart<span><i
                                                        class="fa fa-shopping-cart"></i></span></button>
                    ...
                    <div id="sweet-cookies" class="tab-pane fade">
                        <div class="owl-carousel owl-theme owl-auto-arrow owl-menu">
                            <div>
                                <div class="grid">
                                    <div class="dish-list">
                                        <a href="menu-detail.html"><img src="images/sweet-cookie-1.png"
                                                class="img-fluid" alt="dish-menu" /></a>
                                        <div class="dish-list-text">
                                            <h4><a href="menu-detail.html">Cookie-1</a></h4>
                                            <h5>$45</h5>
                                            <p>Lorem ipsum, Dolor</p>
                                            <button class="btn">Add to cart<span><i
                                                        class="fa fa-shopping-cart"></i></span></button>
                                ...
                                <div class="grid">
                                    <div class="dish-list">
                                        <a href="menu-detail.html"><img src="images/sweet-cookie-2.png"
                                                class="img-fluid" alt="dish-menu" /></a>
                                        <div class="dish-list-text">
                                            <h4><a href="menu-detail.html">Cookie-2</a></h4>
                                            <h5>$45</h5>
                                            <p>Lorem ipsum, Dolor</p>
                                            <button class="btn">Add to cart<span><i
                                                        class="fa fa-shopping-cart"></i></span></button>
                            ...
                            <div>
                                <div class="grid">
                                    <div class="dish-list">
                                        <a href="menu-detail.html"><img src="images/sweet-cookie-3.png"
                                                class="img-fluid" alt="dish-menu" /></a>
                                        <div class="dish-list-text">
                                            <h4><a href="menu-detail.html">Cookie-3</a></h4>
                                            <h5>$45</h5>
                                            <p>Lorem ipsum, Dolor</p>
                                            <button class="btn">Add to cart<span><i
                                                        class="fa fa-shopping-cart"></i></span></button>
                                ...
                                <div class="grid">
                                    <div class="dish-list">
                                        <a href="menu-detail.html"><img src="images/sweet-cookie-4.png"
                                                class="img-fluid" alt="dish-menu" /></a>
                                        <div class="dish-list-text">
                                            <h4><a href="menu-detail.html">Cookie-4</a></h4>
                                            <h5>$45</h5>
                                            <p>Lorem ipsum, Dolor</p>
                                            <button class="btn">Add to cart<span><i
                                                        class="fa fa-shopping-cart"></i></span></button>
                            ...
                            <div>
                                <div class="grid">
                                    <div class="dish-list">
                                        <a href="menu-detail.html"><img src="images/sweet-cookie-5.png"
                                                class="img-fluid" alt="dish-menu" /></a>
                                        <div class="dish-list-text">
                                            <h4><a href="menu-detail.html">Cookie-5</a></h4>
                                            <h5>$45</h5>
                                            <p>Lorem ipsum, Dolor</p>
                                            <button class="btn">Add to cart<span><i
                                                        class="fa fa-shopping-cart"></i></span></button>
                                ...
                                <div class="grid">
                                    <div class="dish-list">
                                        <a href="menu-detail.html"><img src="images/sweet-cookie-6.png"
                                                class="img-fluid" alt="dish-menu" /></a>
                                        <div class="dish-list-text">
                                            <h4><a href="menu-detail.html">Cookie-6</a></h4>
                                            <h5>$45</h5>
                                            <p>Lorem ipsum, Dolor</p>
                                            <button class="btn">Add to cart<span><i
                                                        class="fa fa-shopping-cart"></i></span></button>
