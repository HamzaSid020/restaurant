...
<body id="pizza-homepage" class="page-body">
            ...
            <div id="main-menu">
                ...
                <div class="list-group">
                    ...
                    <div class="collapse sub-menu" id="homepage-links" data-bs-parent="#main-menu">
                        ...
                        <a href="#" class="list-group-item active">Pizza</a>
    ...
    <div id="shopping-cart-sidebar" class="shc-sidebar">
        <ul class="list-unstyled cart-list">
            <li>
                <div class="cart-item">
                    <div class="item-text dish-list-text">
                        <h4><a href="#">Pizza-3</a></h4>
                        <p>Lorem ipsum,dolor</p>
                        <h5>Qty: <input type="number" class="form-control" min="1" value="1"> x $45</h5>
                    </div><!-- end item-text -->

                    <div class="item-img">
                        <a href="#"><img src="images/dish-pizza-3.png" class="img-fluid" alt="cart-item-img" /></a>
                    </div><!-- end item-img -->
            ...
            <li>
                <div class="cart-item">
                    <div class="item-text dish-list-text">
                        <h4><a href="#">Pizza-4</a></h4>
                        <p>Lorem ipsum,dolor</p>
                        <h5>Qty: <input type="number" class="form-control" min="1" value="1"> x $45</h5>
                    </div><!-- end item-text -->

                    <div class="item-img">
                        <a href="#"><img src="images/dish-pizza-4.png" class="img-fluid" alt="cart-item-img" /></a>
                    </div><!-- end item-img -->
    ...
    <div id="user-profile-sidebar" class="user-prf-sidebar">
        <div class="user-prf-sidebar-img text-center" style="background:url('images/usr-prf-back-pizza.jpg') center center;
    ...
    <div class="canvas">
        ...
        <!--=========== SLIDER ==========-->
        <div class="flexslider slider-2" id="slider">
            <ul class="slides">

                <li class="item-1"
                    style="background:linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('images/pizza-slider-1.jpg') center center; background-size:cover;">
                ...
                <li class="item-2"
                    style="background:linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('images/pizza-slider-2.jpg') center center; background-size:cover;">
                    <div class="container text-center meta">
                        <p>Delicious Place</p>
                        <h1>Its Time to Taste</h1>
                        <button class="btn btn-orange btn-radius">Read More</button>
        ...
        <section id="about-us" class="section-padding">
            <div class="container-fluid text-center">
                ...
                <img src="images/about-img-pizza.png" class="img-fluid" alt="about-img" />
            ...
            <div class="container-fluid text-center">
                ...
                <div class="owl-carousel owl-theme owl-menu">
                    <div>
                        <div class="grid">
                            <div class="dish-list">
                                <a href="menu-detail.html"><img src="images/dish-pizza-1.png" class="img-fluid"
                                        alt="dish-menu" /></a>
                                <div class="dish-list-text">
                                    <h4><a href="menu-detail.html">Pizza-1</a></h4>
                                    <h5>$45</h5>
                                    <p>Lorem ipsum, Dolor</p>
                        ...
                        <div class="grid">
                            <div class="dish-list">
                                <a href="menu-detail.html"><img src="images/dish-pizza-2.png" class="img-fluid"
                                        alt="dish-menu" /></a>
                                <div class="dish-list-text">
                                    <h4><a href="menu-detail.html">Pizza-2</a></h4>
                                    <h5>$45</h5>
                                    <p>Lorem ipsum, Dolor</p>
                                    <button class="btn btn-orange">Add to cart<span><i
                                                class="fa fa-shopping-cart"></i></span></button>
                    ...
                    <div>
                        <div class="grid">
                            <div class="dish-list">
                                <a href="menu-detail.html"><img src="images/dish-pizza-3.png" class="img-fluid"
                                        alt="dish-menu" /></a>
                                <div class="dish-list-text">
                                    <h4><a href="menu-detail.html">Pizza-3</a></h4>
                                    <h5>$45</h5>
                                    <p>Lorem ipsum, Dolor</p>
                                    <button class="btn btn-orange">Add to cart<span><i
                                                class="fa fa-shopping-cart"></i></span></button>
                        ...
                        <div class="grid">
                            <div class="dish-list">
                                <a href="menu-detail.html"><img src="images/dish-pizza-4.png" class="img-fluid"
                                        alt="dish-menu" /></a>
                                <div class="dish-list-text">
                                    <h4><a href="menu-detail.html">Pizza-4</a></h4>
                                    <h5>$45</h5>
                                    <p>Lorem ipsum, Dolor</p>
                                    <button class="btn btn-orange">Add to cart<span><i
                                                class="fa fa-shopping-cart"></i></span></button>
                    ...
                    <div>
                        <div class="grid">
                            <div class="dish-list">
                                <a href="menu-detail.html"><img src="images/dish-pizza-5.png" class="img-fluid"
                                        alt="dish-menu" /></a>
                                <div class="dish-list-text">
                                    <h4><a href="menu-detail.html">Pizza-5</a></h4>
                                    <h5>$45</h5>
                                    <p>Lorem ipsum, Dolor</p>
                                    <button class="btn btn-orange">Add to cart<span><i
                                                class="fa fa-shopping-cart"></i></span></button>
                        ...
                        <div class="grid">
                            <div class="dish-list">
                                <a href="menu-detail.html"><img src="images/dish-pizza-6.png" class="img-fluid"
                                        alt="dish-menu" /></a>
                                <div class="dish-list-text">
                                    <h4><a href="menu-detail.html">Pizza-6</a></h4>
                                    <h5>$45</h5>
                                    <p>Lorem ipsum, Dolor</p>
                                    <button class="btn btn-orange">Add to cart<span><i
                                                class="fa fa-shopping-cart"></i></span></button>
