...
<body class="page-body">
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <div id="main-menu">
                ...
                <div class="list-group">
                    ...
                    <a href="#pages-links" class="list-group-item active" data-bs-toggle="collapse"><span><i
                    ...
                    <div class="collapse sub-menu" id="pages-links" data-bs-parent="#main-menu">
                        ...
                        <a href="#" class="list-group-item active">About Us 2</a>
        ...
        <div class="sidenav-2 sidenav-pane">
            ...
            <div class="white-menu">
                ...
                <div class="list-group">
                    ...
                    <a href="#pages-links-2" class="list-group-item active" data-bs-toggle="collapse"><span><i
                                class="fa fa-clone sidebar-icon"></i></span>Pages<span><i
                                class="fa fa-caret-down arrow"></i></span></a>
    ...
    <div class="canvas">
        ...
        <div class="page-cover">
            <div class="container-fluid">
                <h3><span class="cover-left-icon float-start"><i class="fa fa-info"></i></span>About Us 2<span
                ...
                <div class="container-fluid text-center">
                    ...
                    <div class="custom-tabs">
                        <ul class="nav nav-tabs justify-content-center">
                            <li class="nav-item"><a class="nav-link active" href="#tab-history"
                                    data-bs-toggle="tab"><span><i class="fa fa-info"></i></span>History</a></li>
                            <li class="nav-item"><a class="nav-link" href="#tab-mission" data-bs-toggle="tab"><span><i
                                            class="fa fa-dot-circle"></i></span>Mission</a></li>
                        </ul>
                        ...
                        <div class="tab-content">
                            <div id="tab-history" class="tab-pane active">
                                ...
                                <div id="services" class="no-back mt-4">
                            ...
                            <div id="tab-mission" class="tab-pane fade">
                    ...
                    <img src="images/chefs.png" class="img-fluid mt-4" alt="about-img" />
                </div><!-- end container-fluid -->
            </div><!-- end about-page-2 -->
