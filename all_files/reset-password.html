...
<body class="page-body">
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <div id="main-menu">
                ...
                <div class="list-group">
                    ...
                    <a href="#user-links" class="list-group-item active" data-bs-toggle="collapse"><span><i
        ...
        <div class="sidenav-2 sidenav-pane">
            ...
            <div class="white-menu">
                ...
                <div class="list-group">
                    ...
                    <a href="#user-links-2" class="list-group-item active" data-bs-toggle="collapse"><span><i
                                class="fa fa-user sidebar-icon"></i></span>User<span><i
                                class="fa fa-caret-down arrow"></i></span></a>
    ...
    <div class="canvas">
        ...
        <div class="page-cover">
            <div class="container-fluid">
                <h3><span class="cover-left-icon float-start"><i class="fa fa-question"></i></span>Reset Password<span
            ...
            <div id="forgot-password-page">
                <div class="container-fluid text-center">
                    ...
                    <form class="custom-form">
                        ...
                        <button class="btn btn-orange btn-radius">Done</button>
                    </form>
