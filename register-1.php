        ...
        <div id="mySidenav" class="sidenav">
            ...
            <div id="main-menu">
                ...
                <div class="list-group">
                    ...
                    <a href="#features-links" class="list-group-item active" data-bs-toggle="collapse"><span><i
                    ...
                    <div class="collapse sub-menu mega-sub-menu" id="features-links" data-bs-parent="#main-menu">
                        ...
                        <a href="#form-style-links" class="list-group-item active" data-bs-toggle="collapse">Forms<span><i
                                    class="fa fa-caret-down arrow"></i></span></a>
                        <div class="collapse sub-menu mega-sub-menu-links" id="form-style-links">
                            ...
                            <a href="#" class="list-group-item active">Register 1</a>
        ...
        <div class="sidenav-2 sidenav-pane">
            ...
            <div class="white-menu">
                ...
                <div class="list-group">
                    ...
                    <a href="#features-links-2" class="list-group-item active" data-bs-toggle="collapse"><span><i
                                class="fa fa-puzzle-piece sidebar-icon"></i></span>Features<span><i
                                class="fa fa-caret-down arrow"></i></span></a>
                    <div class="collapse sub-menu mega-sub-menu" id="features-links-2" data-bs-parent=".white-menu">
                        ...
                        <a href="#form-style-links-2" class="list-group-item active"
                            data-bs-toggle="collapse">Forms<span><i class="fa fa-caret-down arrow"></i></span></a>
