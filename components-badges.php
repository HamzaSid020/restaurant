            ...
            <div id="main-menu">
                ...
                <div class="list-group">
                    ...
                    <div class="collapse sub-menu" id="components-links" data-bs-parent="#main-menu">
                        ...
                        <a href="components-badges.html" class="list-group-item active">Badges</a>
        ...
        <section class="page-wrapper innerpage-section-padding">
            <div class="container-fluid">
                <div class="badges-page">
                    <div class="heading-1">
                        <h4 class="heading-child">Badges Colored Default</h4>
                    </div>

                    <div class="badges-wrapper">
                        <ul>
                            <li><img src="images/user-profile.jpg" alt="badge-user-profile">John Doe <div
                                    class="badge bg-primary">20</div>
                            </li>
                            <li><img src="images/user-profile.jpg" alt="badge-user-profile">John Doe <div
                                    class="badge bg-success">10</div>
                            </li>
                            <li><img src="images/user-profile.jpg" alt="badge-user-profile">John Doe <div
                                    class="badge bg-danger">19</div>
                            </li>
                            <li><img src="images/user-profile.jpg" alt="badge-user-profile">John Doe <div
                                    class="badge bg-secondary">16</div>
                            </li>
                            <li><img src="images/user-profile.jpg" alt="badge-user-profile">John Doe <div
                                    class="badge bg-info">30</div>
                            </li>
                            <li><img src="images/user-profile.jpg" alt="badge-user-profile">John Doe <div
                                    class="badge bg-warning">40</div>
                            </li>
                            <li><img src="images/user-profile.jpg" alt="badge-user-profile">John Doe <div
                                    class="badge bg-light text-dark">17</div>
                            </li>
                            <li><img src="images/user-profile.jpg" alt="badge-user-profile">John Doe <div
                                    class="badge bg-dark">60</div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="heading-1">
                        <h4 class="heading-child">Badges Corners Custom</h4>
                    </div>

                    <div class="badges-wrapper badge-corner">
                        <ul>
                            <li><img src="images/user-profile.jpg" alt="badge-user-profile">John Doe <div
                                    class="badge badge-corner-1 bg-success">20</div>
                            </li>
                            <li><img src="images/user-profile.jpg" alt="badge-user-profile">John Doe <div
                                    class="badge badge-corner-2 bg-success">10</div>
                            </li>
                            <li><img src="images/user-profile.jpg" alt="badge-user-profile">John Doe <div
                                    class="badge badge-corner-3 bg-success">19</div>
                            </li>
                            <li><img src="images/user-profile.jpg" alt="badge-user-profile">John Doe <div
                                    class="badge badge-corner-4 bg-success">16</div>
                            </li>
                            <li><img src="images/user-profile.jpg" alt="badge-user-profile">John Doe <div
                                    class="badge badge-corner-5 bg-success">30</div>
                            </li>
                            <li><img src="images/user-profile.jpg" alt="badge-user-profile">John Doe <div
                                    class="badge badge-corner-6 bg-success">40</div>
                            </li>
                            <li><img src="images/user-profile.jpg" alt="badge-user-profile">John Doe <div
                                    class="badge badge-corner-7 bg-success">17</div>
                            </li>
                            <li><img src="images/user-profile.jpg" alt="badge-user-profile">John Doe <div
                                    class="badge badge-corner-8 bg-success">60</div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="heading-1">
                        <h4 class="heading-child">Badges Sizes Custom</h4>
                    </div>

                    <div class="badges-wrapper badge-sizes">
                        <ul>
                            <li><img src="images/user-profile.jpg" alt="badge-user-profile">John Doe <div
                                    class="badge badge-size-1 bg-success">20</div>
                            </li>
                            <li><img src="images/user-profile.jpg" alt="badge-user-profile">John Doe <div
                                    class="badge badge-size-2 bg-success">10</div>
                            </li>
                            <li><img src="images/user-profile.jpg" alt="badge-user-profile">John Doe <div
                                    class="badge badge-size-3 bg-success">19</div>
                            </li>
                            <li><img src="images/user-profile.jpg" alt="badge-user-profile">John Doe <div
                                    class="badge badge-size-4 bg-success">16</div>
                            </li>
                            <li><img src="images/user-profile.jpg" alt="badge-user-profile">John Doe <div
                                    class="badge badge-size-5 bg-success">30</div>
                            </li>
                            <li><img src="images/user-profile.jpg" alt="badge-user-profile">John Doe <div
                                    class="badge badge-size-6 bg-success">40</div>
                            </li>
                        </ul>
                    </div>
                </div>
